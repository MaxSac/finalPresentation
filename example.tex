...
\begin{frame}
  \begin{block}{Separation}<1-3>
	...
	\end{figure}
  \end{block}
  \begin{block}{Überwachtes Lernen}<2-3>
	\begin{figure}
	  \centering
...
\begin{frame}
	...
	\begin{itemize}
	  ...
	  \item<4-> gemessene Protonen sollten den echten Verteilungen folgen
		\begin{itemize}
		  \item<4-> Verbesserung der Seperation
		\end{itemize}
	  \item<5-> Proton-Simulation kann eingestellt werden
	\end{itemize}
  \end{frame}
