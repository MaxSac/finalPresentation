...
\begin{frame}{Trainingsdaten}
	...
	\end{figure}
	\begin{itemize}
	  \item<1-> Trainingsdaten simuliert mit CORSIKA \textbf{, sowie Detektorsimulationen} 
	  \item<3-> gemessener Untergrund folgt der wahren Verteilung
		\begin{itemize}
		  \item<3-> Verbesserung der Separation
		\end{itemize}
	  \item<4-> Protonen-Simulation kann eingestellt werden
	\end{itemize}
  \end{frame}
...
\begin{frame}{Erstellen Trainingsdatensatzes}
  \begin{columns}[onlytextwidth]
	...
	\begin{figure}
	  ...
	  \includegraphics<2>[width=\textwidth]{./Plots/roc_info.pdf}
	  \includegraphics[height=0.9\textheight]<3>{./Plots/theta_cut.pdf}
	\end{figure}
	\column{.5\textwidth}
...
\begin{frame}{Überprüfen Trainingsdatensatzes}
  \begin{columns}[onlytextwidth]
	...
	\column{.5\textwidth}
	\begin{itemize}
	  \item simulierte Proton-Datensets werden durch verschiedene Theta-Schnitte erstellt
