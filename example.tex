...
\begin{frame}{Trainingsdaten}
	...
	\end{figure}
	\begin{itemize}
	  \item<1-> Prozessierte Monte Carlo-Simulationen mit CORSIKA
	  \item<3-> gemessener Untergrund folgt der wahren Verteilungen
		\begin{itemize}
...
\begin{frame}{Erstellen Trainingsdatensatzes}
  \begin{columns}[onlytextwidth]
	...
	\end{figure}
	\column{.5\textwidth}
	Bereinigen der gemessen Daten von Gamma-Ereignissen 
	\begin{itemize}
